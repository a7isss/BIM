...
export interface Annotation {
    id: string;
    kind: 'dimension' | 'text' | 'label' | 'arrow';
    x: number;
    y: number;
    text?: string;
    rotation?: number;
...
export type EditTool = 'select' | 'move' | 'delete' | 'copy' | 'rotate' | 'add_arch_wall' | 'split_wall' | 'add_door' | 'add_window' | 'add_column' | 'add_beam' | 'add_footing' | 'add_room' | 'add_touchup' | 'add_text' | 'add_dimension';
