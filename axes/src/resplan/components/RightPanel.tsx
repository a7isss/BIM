...
interface RightPanelProps {
    ...
    openSchedule?: () => void;
    viewMode?: 'plan' | 'elevation' | '3d';
    setViewMode?: (mode: 'plan' | 'elevation' | '3d') => void;
                    ...
                    <div className="mb-8">
                        <div className="flex bg-zinc-800/50 rounded-lg border border-zinc-700 p-1">
                            ...
                            <button
                                ...
                                className={`flex-1 text-sm font-medium py-1.5 rounded-md transition-colors ${viewMode === '3d' ? 'bg-indigo-600 text-white shadow-sm' : 'text-zinc-400 hover:text-white'}`}
                            >
                                3D
                            </button>
                        </div>
